...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *NameLabelSelector) DeepCopyInto(out *NameLabelSelector) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new NameLabelSelector.
func (in *NameLabelSelector) DeepCopy() *NameLabelSelector {
	if in == nil {
		return nil
	}
	out := new(NameLabelSelector)
	in.DeepCopyInto(out)
	return out
}
